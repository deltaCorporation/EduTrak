...
<i class="fas fa-users"></i>
            ...
            ';
                ...
                <div class="contact-information">
                    ...
                    <div class="profile-header-information contact-tab">
                        <button class="contact-tablinks" id="employeeDefaultOpen" onclick="openCity(event, 'contact-information', 'grid')"><i class="fas fa-info"></i>Information</button>
                        <button class="contact-tablinks" onclick="openCity(event, 'contact-notes', 'grid')"><i class="fas fa-sticky-note"></i>Notes</button>
                    </div>
                    ...
                    <form action="updateEmployee.php" method="post" class="contact-form-information contact-tabcontent" id="contact-information">
                        ...
                        <div class="contact-form-information-row">
                            <div class="contact-form-information-cell info-form-x-8">
                                <label>Joined</label>
                                <input type="text" name="Joined" disabled value="<?php echo $employee->data()->joined ?>">
                            </div>
                            ...
                            if($user->hasPermission('superAdmin')){
                                if(!empty($note->getNotes())) {
                                    ...
                                    foreach ($note->getNotes() as $note) {
                                        ...
                                        if ($note->section == 'employee' && $note->contactsID) {
